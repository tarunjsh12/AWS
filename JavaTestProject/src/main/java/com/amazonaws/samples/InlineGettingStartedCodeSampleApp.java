...
public class InlineGettingStartedCodeSampleApp {
     ...
     *      (C:\\Users\\Tarun\\.aws\\credentials) where the sample code will load the
     *      credentials from.
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\Tarun\\.aws\\credentials), and is in valid format.",
                    e);
        }
